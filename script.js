...
const translations = {
  en: {
    ...
    strategaLinksLabel: 'Stratega project links',
    liveAppLink: 'Live app',
    backendRepoLink: 'Back-end repo',
    frontendRepoLink: 'Front-end repo',
    cuponomiaStatus: 'Demo ready',
    cuponomiaType: 'Event-driven microservices',
    cuponomiaDescription: 'A coupon platform split into management and checkout validation services, using Kafka events, independent databases, domain rules, and Swagger examples for hands-on review.',
    cuponomiaLinksLabel: 'Cuponomia project links',
    githubRepoLink: 'GitHub repo',
    demoGuideLink: 'Demo guide',
  ...
  'pt-BR': {
    ...
    strategaLinksLabel: 'Links do projeto Stratega',
    liveAppLink: 'Aplicação online',
    backendRepoLink: 'Repo Back-end',
    frontendRepoLink: 'Repo Front-end',
    cuponomiaStatus: 'Demo pronta',
    cuponomiaType: 'Microsserviços orientados a eventos',
    cuponomiaDescription: 'Plataforma de cupons dividida entre serviços de gestão e validação de checkout, usando eventos Kafka, bancos independentes, regras de domínio e exemplos no Swagger para avaliação prática.',
    cuponomiaLinksLabel: 'Links do projeto Cuponomia',
    githubRepoLink: 'Repo GitHub',
    demoGuideLink: 'Guia demo',
